...
// Panel: GDEW1248Z95 : https://www.e-paper-display.com/products_detail/productId=408.html
...
class GxEPD2_1248c : public GxEPD2_EPD
{
  public:
    ...
    static const GxEPD2::Panel panel = GxEPD2::GDEW1248Z95;
    ...
    GxEPD2_1248c(int8_t sck, int8_t miso, int8_t mosi,
    ...
    GxEPD2_1248c(int8_t cs_m1, int8_t cs_s1, int8_t cs_m2, int8_t cs_s2,
                int8_t dc1, int8_t dc2, int8_t rst1, int8_t rst2,
                int8_t busy_m1, int8_t busy_s1, int8_t busy_m2, int8_t busy_s2);
    // constructor with minimal parameter set, standard SPI, dc1 and dc2, rst1 and rst2 to one pin, one busy used (can be -1)
    GxEPD2_1248c(int8_t cs_m1, int8_t cs_s1, int8_t cs_m2, int8_t cs_s2, int8_t dc, int8_t rst, int8_t busy);
    // methods (virtual)
